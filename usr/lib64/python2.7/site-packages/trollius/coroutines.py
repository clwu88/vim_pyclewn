...
# Opcode of "yield asyncio.From" instruction
_YIELD_FROM = opcode.opmap.get('YIELD_FROM', None)

# If you set _DEBUG to true, @coroutine will wrap the resulting
# generator objects in a CoroWrapper instance (defined below).  That
# instance will log a message when the generator is never iterated
# over, which may happen when you forget to use "yield asyncio.From" with a
...
if compat.PY33 and not compat.PY35:
    ...
    # "yield asyncio.From trollius_coroutine". Task._step() does not receive the Return
    # exception, because "yield asyncio.From" handles it internally. So it's not
...
def _coroutine_at_yield_from(coro):
    """Test if the last instruction of a coroutine is "yield asyncio.From".
...
class CoroWrapper:
    ...
    if _YIELD_FROM_BUG:
        # For for CPython issue #21209: using "yield asyncio.From" and a custom
...
if events.asyncio is not None:
    ...
    elif hasattr(events.asyncio, 'tasks'):
