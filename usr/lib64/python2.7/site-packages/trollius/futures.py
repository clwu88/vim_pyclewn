...
class _TracebackLogger(object):
    ...
    one callback (typically set by 'yield asyncio.From') and usually that
...
class Future(object):
    ...
    _blocking = False  # proper use of future (yield vs yield asyncio.From)
...
if events.asyncio is not None and hasattr(events.asyncio, 'Future'):
